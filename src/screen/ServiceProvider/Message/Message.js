...
import {
  ...
  from "native-base";
  import Sidemenu from '../ServiceProfileSideBar';
  ...
  render() {
    ...
    return (
      ...
      //   </View>
        ...
        <Text style={{textAlign:"center",fontSize:20,fontWeight:'bold'}}>Message</Text>
    ...
    alignSelf:'center'}}>
      {
          ...
          <View style={{flexDirection:'row'}}>
            ...
            <Text style={{flexDirection: 'column',paddingLeft:7,flexWrap:'wrap',flexGrow:1,flexShrink:1,fontSize:11}}>{item.subject}</Text>
             ...
             <Text style={{fontSize:rem*1,marginLeft:rem*1,textDecorationLine:"underline"}} 
